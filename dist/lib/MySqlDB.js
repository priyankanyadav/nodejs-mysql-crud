...
export class MySqlDB {
    ...
    connection = null;
    constructor() {
        this.dbConnectionFields = new DBConnectionFields(String(process.env.SQL_HOST), String(process.env.SQL_USER), String(process.env.SQL_PASSWORD), String(process.env.SQL_DB_NAME));
    }
    async connect() {
        let connectResponse = {
            isConnected: false,
    ...
    async query(sqlStatement, options = []) {
        let queryResult;
